	...
	String url = "https://api.elsevier.com/content/search/scopus?query=DOI%28" + a + "%29&view=complete";
		...
		if(this.totalResults>0) {
			...
			for(Object o: jsEntries) {
                          ...
                          //doi=(jo.get("dc:doi")!=null?( (String)jo.get("dc:doi")):"");
                            System.out.println("El numero de citas es : " + citas);
                            System.out.println("El doi es : " + doi);
                            
                            
                            System.out.println("El titulo es : " + ti);
                            ...
                            System.out.println("h-index del autor " + i + " : " + hindex[i-1]);
                               ...
                               System.out.println("\nEl numero de citas es : " + citas +" este es el titulo  "+ti );
       String jsonString =  "{\"infile\": [{\"field1\": 11,\"field2\": 12,\"field3\":}]}";
    System.out.println("\n creando docuemnto");
    // String jsonString = "{\"infile\": [{\"Titulo\":"+ti+",\"Citas\":"+citas+"\",\"DOI\":"+ti+"}]}";
